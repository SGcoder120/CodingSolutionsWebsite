...
function AlgebraTiles() {
  return (
    <div className="algebra-tiles">
      <h2 className="title">Algebra Tiles</h2>
      <p className="description">
        Drag and drop tiles to create algebraic expressions. Use the palette to add tiles.
      </p>
      {/* Palette and workspace will be implemented here */}
    </div>
  )
